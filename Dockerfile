...
COPY  /home/vsts/work/1/s/tomcat-usesr.xml /usr/local/tomcat/conf/tomcat-users.xml
COPY  /home/vsts/work/1/s/context.xml /usr/local/tomcat/webapps/manager/META-INF/context.xml
